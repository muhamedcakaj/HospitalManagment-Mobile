...
public class DiagnosesAdapter extends RecyclerView.Adapter<com.example.hospital_managment.UserDashboard.Diagnoses.DiagnosesAdapter.ViewHolder> {

    private List<com.example.hospital_managment.UserDashboard.Diagnoses.DiagnosesModel> diagnosesList;

    public DiagnosesAdapter(List<com.example.hospital_managment.UserDashboard.Diagnoses.DiagnosesModel> diagnosesList) {
    ...
    @NonNull
    @Override
    public com.example.hospital_managment.UserDashboard.Diagnoses.DiagnosesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_diagnosis, parent, false);
        return new com.example.hospital_managment.UserDashboard.Diagnoses.DiagnosesAdapter.ViewHolder(v);
    }
